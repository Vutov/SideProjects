...
string [] chiHuyParams = chiHuyParams1;
 ...
 break;
 case "PrintAllTheaters": chiHuyResult = Class1.ExecutePrintAllTheatresCommand();
break;
...
break;
case "PrintAllPerformances": chiHuyResult = ExecutePrintAllPerformancesCommand();
 break;
...
var kiemTra = (ss <= ss2 && ss2 <= ee) || (ss <= ee2 && ee2 <= ee) ||(ss2 <= ss && ss <= ee2) ||(ss2 <= ee && ee <= ee2);
if (kiemTra)
{
 return true;
}
